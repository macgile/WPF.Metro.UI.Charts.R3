namespace GravityApps.Mandelkow.MetroCharts
{
    ...
    public class IsNegativeToVerticalAlignmentConverter : IValueConverter
    {
#if NETFX_CORE
        ...
        {
            bool isNegative = (bool)value;
            return isNegative ? VerticalAlignment.Bottom : VerticalAlignment.Top;
        }
    }
}
